...
class PokerGame{
    public:
        void start(string name){
            ...
            players[0].name = "Alex";
            players[1].name = "Ivan";
            players[2].name =  "Boris";
            players[3].name = "Lisa";
            players[4].name = name;
            players[5].name = "Katya";
            startGame();
        }
        ...
        void printTable(){
			cout << "  " << ((!players[0].round) ? "flops " : "      ") << "       " << ((!players[1].round) ? "flops " : "      ") << "         "
            << ((!players[2].round) ? "flops " : "      ") << endl;
			...
			cout << "  " << ((!players[5].round) ? "flops " : "      ") << "         " << ((!players[4].round) ? "flops " : "      ") << "        "
            << ((!players[3].round) ? "flops " : "      ") << endl;
			cout << endl;
            if (players[4].round){
                cout << "   Your hand:" << endl;
                cout << "    ___    ___" << endl;
    ...
    private:
        ...
        int bind;
        Card tableCards[5];
        int pot,potBet,action,bet,rational,betOn,winner,maxPoints,roundWinner;
        int handPoints[6];//
        int bestHand[6][3];//
        ...
        void takeBets(){
			...
			if (!potBet) 
				...
				players[bind].goodToGo = 1;            
 
            for (int k=bind+1;k<bind+7;k++){
                /* human player actions */
                if (k%6==4&&players[4].round&&players[4].money>0){
                    if (betOn){
                        ...
                        cin >> action;
						while (action<1||action>3||(players[4].money<=0&&action==3)){
                            cout << "Invalid number pressed." << endl;
                            cout << "Your action: (1) FLOP (2) CHECK (3) BET/CALL ";
                            cin >> action;
                        }
                ...
                /* computers actions */
                    ...
                    if (action==0){
                        ...
                        if (betOn){
							...
							if (players[k%6].money > 0){
							    bet = rand() % (players[k%6].money / 3 + 1) + 10;
								pot+=bet;
        ...
        int getScore(Card hand[]){
            ...
            /* checks for straight*/ // not working
            k=0;
